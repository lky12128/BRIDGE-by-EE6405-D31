...
class BRIDGE_Model(nn.Module):
    def __init__(self, pretrained_encoder, config, cls_index, sep_index, pad_index, msk_index, seed):
        ...
        # store encoder mode for branching
        ...
        # gates steer context and answer memories
    ...
    def dynamic_padding(self, q, r, a):
        bsz = q.size(0)
        # allocate composite sequence buffers
        ...
        for bsz_i in range(bsz):
            ...
            # mask enforces autoregressive decoding
    ...
    def memorygate(self, query, kv_memory, mem_encoder, gate_projector):
        # encoder produces context-aware blend
    ...
    def splithiddenstates(self, all_hid, c_mask, a_mask):
        ...
        # expand masks to select per hidden dimension
    ...
    def memoryupdater(self, c_mem, a_mem, qAr_mask, a_mask, all_hidden):
        # isolate new context and answer slices
    ...
    def forward(self, qrah):
        ...
        # decode answer logits from memory
        output = self.decoder(a_memory)
        for bridge_trg in bridge_trgs:
            # aggregate language modeling loss
