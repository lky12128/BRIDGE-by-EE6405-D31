...
def random_seed(seed):
    # seed python and torch randomness
...
def get_batch(data_source, batch_size):
    ...
    for i in range(0, len(data_source) // batch_size + 1):
        ...
        for batch_j in batch:
            ...
            # reverse reviews to favour recent context
